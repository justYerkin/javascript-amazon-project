...
export function renderPaymentSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    totalProductsCostCents += product.priceCents * cartItem.quantity
  ...
  const totalBeforeTaxCents = totalProductsCostCents + totalShippingCost;
  ...
  const paymentSummaryHTML = `
    ...
    <div class="payment-summary-row">
      ...
      <div class="payment-summary-money">$${formatCurrency(totalProductsCostCents)}</div>
    </div>
